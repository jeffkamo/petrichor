...
Being.prototype.getCurrentHp = function() {
...
Being.prototype.getConservancy = function() {
    var hpPercentile = this.getCurrentHp() / this.getHp();
...
Being.prototype.addDamage = function(damage) {
    var newDamage = this.damage + damage;
...
Being.prototype.kill = function() {
    this.isDead = true;
};

Being.prototype.revive = function() {
    this.isDead = false;
};
